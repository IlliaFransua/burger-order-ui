import { deleteOrder, getPaginatedOrders, PaginatedOrdersTable, usePaginatedOrders } from "@/entities/order"
...
export const OrderTableWidget = ({ initialFilterParams, updateParams }) => {
  const { data: paginatedOrders, isLoading, refetch } = usePaginatedOrders(initialFilterParams)
  ...
  return (
    <PaginatedOrdersTable
      ...
      sortModel={[{ field: initialFilterParams.sort, sort: initialFilterParams.desc ? 'desc' : 'asc' }]}
