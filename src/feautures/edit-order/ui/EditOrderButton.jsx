...
export const EditOrderButton = ({ orderId, isEditMode, allAvailableBurgers, selectedRows, originalBurgerIds, setIsDisabled }) => {
  ...
  function checkIsDesabled() {
    const finalIds = toFinalIds()
    const isDisabled = finalIds.length === 0 || areArraysEqual(originalBurgerIds, finalIds)
